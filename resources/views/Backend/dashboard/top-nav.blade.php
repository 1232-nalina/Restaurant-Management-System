        ...
        <li class="nav-item dropdown noti-dropdown language-drop me-2">
            ...
            <div class="dropdown-menu ">
                <div class="noti-content">
                    <div>
                        <a class="dropdown-item" href="{{ url('locale/en') }}"><i class="flag flag-lr me-2"></i>@lang('public.en')</a>
                        <a class="dropdown-item" href="{{ url('locale/jp') }}"><i class="flag flag-jp me-2"></i>@lang('public.jp')</a>
                    </div>
                </div>
            </div>
        </li>
{{-- 
        ...
        <li class="nav-item dropdown has-arrow new-user-menus">
            <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                <span class="user-img">
                    <img class="rounded-circle" src="{{ asset('Backend/assets/img/profiles/avatar-01.jpg') }}"
                        width="31" alt="admin ">
                    <div class="user-text">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="profile.html"> @lang('public.my-profile') </a>
                <a class="dropdown-item" href="{{route('changepassword.page')}}">@lang('public.change-password')</a>
                {{-- <a class="dropdown-item" href="inbox.html">Inbox</a> --}}

                <a class="dropdown-item" href="{{ route('admin.logout.submit') }}"
                    onclick="event.preventDefault();
                              document.getElementById('admin-logout-form').submit();">@lang('public.logout')</a>
