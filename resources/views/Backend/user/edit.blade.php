            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('users.update',$user->id) }}">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h5 class="form-title"><span>Edit {{ $user->name }}</span></h5>
                            </div>
                            <div class="col-12 col-sm-12 col-md-6">
                                <div class="form-group local-forms">
                                    <label>User Name <span class="login-danger">*</span></label>
                                    <input type="text" class="form-control @error('name')is-invalid @enderror" name="name" placeholder="enter user name" value="{{ $user->name }}">
                                    @error('name')
                            ...
                            <div class="col-12 col-sm-12 col-md-6">
                                <div class="form-group local-forms">
                                    ...
                                    <input type="email" class="form-control @error('started_year')is-invalid @enderror" placeholder="enter user email" name="email" value="{{ $user->email }}">
                                    @error('email')
                                    <p style="color: indianred;margin-top: 5px">{{ $message }}</p>
                                    @enderror
                                </div>
