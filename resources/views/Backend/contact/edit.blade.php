    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Edit Contact Details</h3>
                    <ul class="breadcrumb">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('contact.update', $ContactDetails->id) }}"
                                ...
                                <div class="col-12 col-sm-6 col-md-6">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control @error('address')is-invalid @enderror"
                                            name="address" value="{{ $ContactDetails->address }}"
                                ...
                                <div class="col-12 col-sm-6 col-md-6">
                                    <div class="form-group local-forms" id='editor'>
                                        ...
                                        <input type="email" class="form-control @error('email')is-invalid @enderror"
                                            name="email" value="{{ $ContactDetails->email }}" id="email"
                                ...
                                <div class="col-12 col-sm-6 col-md-6">
                                    <div class="form-group local-forms" id='editor'>
                                        ...
                                        <input type="tel" class="form-control @error('phone_one')is-invalid @enderror"
                                            name="phone_one" value="{{ $ContactDetails->phone_one }}" id="phone_one"
                                ...
                                <div class="col-12 col-sm-6 col-md-6">
                                    <div class="form-group local-forms" id='editor'>
                                        ...
                                        <input type="tel" class="form-control @error('phone_two')is-invalid @enderror"
                                            name="phone_two" value="{{ $ContactDetails->phone_two }}" id="phone_two"
                                ...
                                <div class="col-12 col-sm-6 col-md-6">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="file" class="form-control @error('logo')is-invalid @enderror"
                                            name="logo" value="{{ $ContactDetails->logo }}" placeholder=""
                                            id="image">
                                        @error('logo')
                                            <p style="color: indianred;margin-top: 5px">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="mb-4" id="display_original_image">
                                        @if ($ContactDetails->logo)
                                            <img src="{{ asset('upload/Contact/' . $ContactDetails->logo) }}"
                                                style="max-width: auto; height:250px;" class="img-thumbnail img-fluid"
                                                id="img_prv_1" alt="">
                                        @endif
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6 col-md-6">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="file" class="form-control @error('fab_icon')is-invalid @enderror"
                                            name="fab_icon" value="{{ $ContactDetails->fab_icon }}" placeholder=""
                                            id="image1">
                                        @error('fab_icon')
                                            <p style="color: indianred;margin-top: 5px">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="mb-4" id="display_original_image">
                                        @if ($ContactDetails->logo)
                                            <img src="{{ asset('upload/Contact/' . $ContactDetails->fab_icon) }}"
                                                style="max-width: auto; height:250px;" class="img-thumbnail img-fluid"
                                                id="img_prv_1" alt="">
                                        @endif
                                    </div>
                                ...
                                <div class="col-12 col-sm-6 col-md-6">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="file"
                                            ...
                                            name="banner_image" value="{{ $ContactDetails->banner_image }}"
                                            placeholder="" id="image2">
                                        @error('banner_image')
                                            <p style="color: indianred;margin-top: 5px">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div class="mb-4" id="display_original_image">
                                        @if ($ContactDetails->banner_image)
                                            <img src="{{ asset('upload/Contact/' . $ContactDetails->banner_image) }}"
                                                style="max-width: auto; height:250px;" class="img-thumbnail img-fluid"
                                                id="img_prv_2" alt="">
                                        @endif
                                    </div>
                                ...
                                <div class="col-12 col-sm-6 col-md-6">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text"
                                            ...
                                            name="google_map" value="{{ $ContactDetails->google_map }}" id="google_map"
                                ...
                                <div class="col-12 col-sm-6 col-md-6">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text"
                                            ...
                                            name="facebook_link" value="{{ $ContactDetails->facebook_link }}"
                                ...
                                <div class="col-12 col-sm-6 col-md-6">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text"
                                            ...
                                            name="instagram_link" value="{{ $ContactDetails->instagram_link }}"
                                ...
                                <div class="col-12 col-sm-6 col-md-6">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text"
                                            ...
                                            name="twitter_link" value="{{ $ContactDetails->twitter_link }}"
                                ...
                                <div class="col-12 col-sm-6 col-md-6">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text"
                                            ...
                                            name="gmail_link" value="{{ $ContactDetails->gmail_link }}" id="gmail_link"
